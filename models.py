...
class NearEarthObject:
    ...
    def __init__(self, approaches, designation:str = '', name:str = None, 
    ...
    def __str__(self):
        """Return `str(self)`."""
        return f'A NearEarthObject {self.designation} ({self.name}) has a diameter of {self.diameter:.3f} and is {"" if self.hazardous else "not "} hazardous'
...
class CloseApproach:
    ...
    # TODO: How can you, and should you, change the arguments to this constructor?
    # If you make changes, be sure to update the comments in this file.
    def __init__(self, time:str, distance:float, velocity:float, neo:NearEarthObject = None):
